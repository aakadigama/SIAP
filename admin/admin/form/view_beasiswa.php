	...
	<tr>  	
    	<td>
			<table border='0'>
					...
					<td colspan='2'>";
						...
						echo "
						 <div class='navbar navbar-inner block-header'>
							...
							<div><br><br><br>Tanggal dibuat: ".$data['tanggal_dibuat'].". Penulis: ".$pembuat."</div>
            			</div>					
					</td>					
				<tr>
				...
				<tr>
					<td colspan='2'><br><img src='../$data[gambar]' class='imagebeasiswa' height='200' width='250' /></td>
				</tr>
...
?>
	...
	<a href="?page=edit_beasiswa&kodeedit=<?php echo $kode_beasiswa; ?>">
    ...
    <div class="btn-group">
    	<button data-toggle="dropdown" class="btn btn-success dropdown-toggle">Action <span class="caret"></span></button>
			<ul class="dropdown-menu">
				<li><a href="?page=view_beasiswa&kode=approve_beasiswa-<?php echo $kode_beasiswa;?>">Approve</a></li>
				<li><a href="?page=view_beasiswa&kode=reject_beasiswa-<?php echo $kode_beasiswa;?>&id=<?php echo $kode_beasiswa;?>">Reject</a></li>				
			</ul>
	</div><!-- /btn-group -->
</div>
